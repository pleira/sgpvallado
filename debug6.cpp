      if (help == 'y')
       ...
       printf( "%57s\n",
                        "// ------------------after sgp4init :-------------");
       printf( "checkSgp4Init%d(ini: Sgp4Init) = {\n import ini._\n", satn);
       printf(
          "assert( %7s === %15d); assert( %7s === %15d); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f ); \n",
          "satn ", satn, "yr ", satrec.epochyr, "bstar ", satrec.bstar, "ecco ", satrec.ecco,
       ...
       printf( "//    outputs  :\n");
       printf( "assert( %7s === %15c); assert( %7s === %15d); assert( %7s === %15c); assert( %7s === %15.9f ); \n",
       ...
       printf( "assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f ); \n",
       ...
       printf( "// %17s%15d); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f ); \n",
       ...
       printf( "// %17s%15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f); assert( %7s === %15.9f ); \n",
